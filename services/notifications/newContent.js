...
const templateNewContent = require('../../templates-wa/new_content')
...
async function sendTemplate( client, auth, message ){
    return new Promise ((resolve,reject)=>{
        ...
        let templateName =  client + '_new_notification'

        let template = templateNewContent( '', '', templateName, typeNotification, contentName, group, zone, urlImage )
