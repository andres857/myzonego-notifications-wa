...
const templateNewVideoCall = require('../../templates-wa/new_video_calls')
...
async function sendTemplate( client, auth, message ){
    return new Promise ((resolve,reject)=>{
        ...
        let videocall = message.videocall
        let zone = message.zone
        let urlImage = message.image
        let templateName =  client + '_new_video_calls'

        let template = templateNewVideoCall( '', '', templateName, videocall, zone, urlImage )
